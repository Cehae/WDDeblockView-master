...
//  Github:https://github.com/Cehae/WDDeblockView-master

#import "WDDeblockView.h"
@interface WDDeblockView()
...
-(void)touchesEnded:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    ...
    [self setNeedsDisplay];
    //3.查看当前选中按钮的顺序
    NSString * resultStr = [NSString stringWithString:str];
    !self.WDDeblockResult?:self.WDDeblockResult(resultStr);
}
